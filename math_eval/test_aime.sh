...
python test_aime.py --model_path /mnt/userdata/Logic-RL/Qwen-7B-3ppl/actor/global_step_70 --json_path ./aime_2021_2024.jsonl > log/aime/Qwen-7B-3ppl_70step.log 2>&1 &
wait